...
We compared three models: appraisal-only, TF-IDF text-only, and a fusion model combining both feature types. Overall, the results suggest that appraisal information is helpful on its own and works even better when combined with text.
